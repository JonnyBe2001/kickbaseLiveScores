...
async function login() {
    try {
        ...
        outputElement.textContent = 'Es gab ein Problem beim Login.';
    }
}
...
document.getElementById('getPlayerStats').addEventListener('click', function() {

    const url = `https://api.kickbase.com/leagues/${leagueId}/players/${playerId}/stats`;
