...
async function downloadTor() {
    ...
    try {
        ...
        console.log('✔️ Checkbox "Torhüter" erfolgreich geklickt.');
    } catch (error) {
...
async function downloadAbw() {
    ...
    try {
        ...
        console.log('✔️ Checkbox "Abwehr" erfolgreich geklickt.');
    } catch (error) {
...
async function downloadMf() {
    ...
    try {
        ...
        console.log('✔️ Checkbox "Mittelfeld" erfolgreich geklickt.');
    } catch (error) {
...
async function downloadSt() {
    ...
    try {
        ...
        console.log('✔️ Checkbox "Sturm" erfolgreich geklickt.');
    } catch (error) {
...
async function removePosFilter (page) {
    try {
        ...
        console.log('✔️ Position erfolgreich geklickt.');
    } catch (error) {
        console.log('❌ Fehler beim Klicken auf Position');
    }
    ...
    try {
        ...
        console.log('✔️ Checkbox "(All)" erfolgreich geklickt.');
    } catch (error) {
        console.log('❌ Fehler beim Klicken auf "(All)" Checkbox');
    }
...
async function openPage (page) {
     ...
     try {
        ...
        console.log(`✔️ Öffne URL: ${tableauUrl}`);
     } catch (error) {
        console.log(`❌ Fehler beim öffnen der URL: ${tableauUrl}`)
     }
     ...
     try {
         ...
         console.log('✔️ Seite vollständig geladen.');
     } catch (e) {
...
async function downloadPdf(page, position) {
    ...
    try {
        ...
        console.log('✔️ Download Button gefunden');
        await page.click('//*[@id="download"]');
        console.log('✔️ Download Layout geöffnet');
    } catch (e) {
